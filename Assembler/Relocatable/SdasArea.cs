...
{
    public class SdasArea
    {
        public SdasArea(): this(null, false, false)
        {
        }

        public SdasArea(string name, bool isAbsolute, bool isOverlay)
        {
            Name = name;
        ...
        public static bool operator ==(SdasArea area, string name)
        {
