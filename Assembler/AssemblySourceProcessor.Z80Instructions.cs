    ...
    public partial class AssemblySourceProcessor
    {
        ...
        static readonly Dictionary<string, CpuInstruction[]> Z80Instructions = new(StringComparer.OrdinalIgnoreCase) {
            { "ADC", new CpuInstruction[] {
                ...
                new CpuInstruction( "ADC", "(HL)", null, new byte[] { 0x8e } ),
                new CpuInstruction( "ADC", "(IX+s)", null, new byte[] { 0xdd, 0x8e, 0 }, 2, 1 ),
                new CpuInstruction( "ADC", "(IX)", null, new byte[] { 0xdd, 0x8e, 0 } ),
                new CpuInstruction( "ADC", "(IY+s)", null, new byte[] { 0xfd, 0x8e, 0 }, 2, 1 ),
                new CpuInstruction( "ADC", "(IY)", null, new byte[] { 0xfd, 0x8e, 0 } ),
                new CpuInstruction( "ADC", "A", null, new byte[] { 0x8f } ),
                new CpuInstruction( "ADC", "B", null, new byte[] { 0x88 } ),
                new CpuInstruction( "ADC", "C", null, new byte[] { 0x89 } ),
                new CpuInstruction( "ADC", "D", null, new byte[] { 0x8a } ),
                new CpuInstruction( "ADC", "E", null, new byte[] { 0x8b } ),
                new CpuInstruction( "ADC", "H", null, new byte[] { 0x8c } ),
                new CpuInstruction( "ADC", "L", null, new byte[] { 0x8d } ),
                new CpuInstruction( "ADC", "n", null, new byte[] { 0xce, 0 }, 1, 1 ),
                new CpuInstruction( "ADC", "IXH", null, new byte[] { 0xdd, 0x8c }, isUndocumented: true ),
                new CpuInstruction( "ADC", "IXL", null, new byte[] { 0xdd, 0x8d }, isUndocumented: true ),
                new CpuInstruction( "ADC", "IYH", null, new byte[] { 0xfd, 0x8c }, isUndocumented: true ),
                new CpuInstruction( "ADC", "IYL", null, new byte[] { 0xfd, 0x8d }, isUndocumented: true ) } },
            { "ADD", new CpuInstruction[] {
                ...
                new CpuInstruction( "ADD", "(HL)", null, new byte[] { 0x86 } ),
                new CpuInstruction( "ADD", "(IX+s)", null, new byte[] { 0xdd, 0x86, 0 }, 2, 1 ),
                new CpuInstruction( "ADD", "(IX)", null, new byte[] { 0xdd, 0x86, 0 } ),
                new CpuInstruction( "ADD", "(IY+s)", null, new byte[] { 0xfd, 0x86, 0 }, 2, 1 ),
                new CpuInstruction( "ADD", "(IY)", null, new byte[] { 0xfd, 0x86, 0 } ),
                new CpuInstruction( "ADD", "A", null, new byte[] { 0x87 } ),
                new CpuInstruction( "ADD", "B", null, new byte[] { 0x80 } ),
                new CpuInstruction( "ADD", "C", null, new byte[] { 0x81 } ),
                new CpuInstruction( "ADD", "D", null, new byte[] { 0x82 } ),
                new CpuInstruction( "ADD", "E", null, new byte[] { 0x83 } ),
                new CpuInstruction( "ADD", "H", null, new byte[] { 0x84 } ),
                new CpuInstruction( "ADD", "L", null, new byte[] { 0x85 } ),
                new CpuInstruction( "ADD", "n", null, new byte[] { 0xc6, 0 }, 1, 1 ),
                new CpuInstruction( "ADD", "IXH", null, new byte[] { 0xdd, 0x84 }, isUndocumented: true ),
                new CpuInstruction( "ADD", "IXL", null, new byte[] { 0xdd, 0x85 }, isUndocumented: true ),
                new CpuInstruction( "ADD", "IYH", null, new byte[] { 0xfd, 0x84 }, isUndocumented: true ),
                new CpuInstruction( "ADD", "IYL", null, new byte[] { 0xfd, 0x85 }, isUndocumented: true ) } },
