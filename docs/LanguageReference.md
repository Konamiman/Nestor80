...
Nestor80 supports Z80, R800 🆕 and Z280 🆕 CPU instructions, being Z80 the default CPU; a `.CPU R800` instruction can be used to enable support for R800 instructions, and likewise, `.CPU Z280` enables support for Z280 instructions (see also ["Z280 support"](Z280Support.md)). The 8080 CPU is not supported by Nestor80. 🚫
