...
* [**Programmatic API**](docs/ProgrammaticAPI.md), all you need to know if you want to use Nestor80 to assemble Z80 code from your own .NET-capable code.

To get the full reference of the existing command line arguments you can run Nestor80 with the `--help` argument, or you can look at [the help text in the Nestor80 source code](https://github.com/Konamiman/Nestor80/blob/master/N80/Program.Help.cs).
